...
>
  ...
  <div class="row">
    <div class="cell">
      <a href="verbs/english" style="color:inherit">1,436 <%= resourceBundles.getString("English verbs") %></a>
      <%= resourceBundles.getString("and") %>
      <a href="verbs/irish" style="color:inherit">773 <%= resourceBundles.getString("Irish verbs") %></a>
